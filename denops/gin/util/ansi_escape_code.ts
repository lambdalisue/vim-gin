...
import * as ansiEscapeCode from "https://deno.land/x/ansi_escape_code@v1.0.3/mod.ts";
import * as batch from "https://deno.land/x/denops_std@v6.5.1/batch/mod.ts";
import { Decoration } from "https://deno.land/x/denops_std@v6.5.1/buffer/mod.ts";
