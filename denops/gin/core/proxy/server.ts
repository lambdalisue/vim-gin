...
import * as anonymous from "https://deno.land/x/denops_std@v3.9.2/anonymous/mod.ts";
import * as autocmd from "https://deno.land/x/denops_std@v3.9.2/autocmd/mod.ts";
...
import * as streams from "https://deno.land/std@0.165.0/streams/mod.ts";
import { deferred } from "https://deno.land/std@0.165.0/async/mod.ts";
