...
import * as mapping from "https://deno.land/x/denops_std@v3.12.0/mapping/mod.ts";
...
} from "https://deno.land/x/denops_std@v3.12.0/bufname/mod.ts";
import {
  builtinOpts,
  Flags,
  formatFlags,
  parseOpts,
  validateOpts,
} from "https://deno.land/x/denops_std@v3.12.0/argument/mod.ts";
